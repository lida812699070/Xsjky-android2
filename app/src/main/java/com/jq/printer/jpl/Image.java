...
public class Image extends BaseJPL
{
	...
	public boolean drawOut(int x,int y,Bitmap bitmap,IMAGE_ROTATE rotate){

		//String path = Environment.getExternalStorageDirectory().toString() + "/print1.png";
	...
	public boolean drawOut(int x,int y,Resources res,int id,IMAGE_ROTATE rotate)
	{
		...
		return drawOut(x, y, bitmap, rotate);
	}
}
