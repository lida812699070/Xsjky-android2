...
public class BNDemoMainActivity extends Activity {
    ...
    private static final String APP_FOLDER_NAME = "wwww";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sarech);
...
//            showToastMsg("TTSPlayStateListener : TTS play start");
    ...
    private void initNavi() {
        ...
        }, mTTSCallback, ttsHandler, new BaiduNaviManager.TTSPlayStateListener() {
            @Override
            public void playStart() {
