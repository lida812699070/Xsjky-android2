...
public class DocumentQueryBySalesmanActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        String beginTime = "";
        beginTime = DateFormatUtils.getData(System.currentTimeMillis() - (long) (2l * 365l * 24l * 60l * 60l * 1000l));
        ...
        params.addBodyParameter("customerName", "");
