...
public class FragmentStatisticsMonthFragment extends Fragment {


    private PullToRefreshListView mLvMonth;
    private ArrayList<ReceiverStatData> mList;
    private ItemStatisticsAdapter<ReceiverStatData> mAdapter;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_statistics_month, null);
    }
    ...
    private void findviews(View view) {
       /* HealthyTablesView healthyTablesView = (HealthyTablesView) view.findViewById(R.id.month_fr_ht);
        healthyTablesView.setData(new String[]{"02", "03", "04", "05", "06", "07", "08"}, new int[]{33, 35, 24, 12, 18, 26, 46});*/
        ...
        mLvMonth = (PullToRefreshListView) view.findViewById(R.id.frament_month_statistics);
        View inflate = LayoutInflater.from(getContext()).inflate(R.layout.listview_empty_view, null);
        mLvMonth.setEmptyView(inflate);
        mLvMonth.setMode(PullToRefreshBase.Mode.BOTH);
        mLvMonth.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
    ...
    private void initdata() {
        ...
        params.addBodyParameter("period", "Month");
