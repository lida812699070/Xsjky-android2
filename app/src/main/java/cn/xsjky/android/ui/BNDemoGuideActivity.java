...
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapApplyLocation.activityList.add(this);
    ...
    protected void onDestroy() {
        ...
        MapApplyLocation.activityList.remove(this);
                ...
                public void handleMessage(android.os.Message msg) {
                    if (msg.what == MSG_SHOW) {
                        ...
                        BNRouteGuideManager.getInstance().resetEndNodeInNavi(
                                new BNRoutePlanNode(MapApplyLocation.start.longitude,MapApplyLocation.location.longitude, "终点", null, CoordinateType.GCJ02));
                    }
                };
            };
        }
